...
return [
    ...
    'LICENSE_VALIDATOR' => env('LICENSE_VALIDATOR', 'https://localhost:8000'),
    'LICENSE_ACTIVATED' => env('LICENSE_ACTIVATED', 'installed'),
    'LICENSE_ACTIVATED_URL' => env('LICENSE_ACTIVATED_URL', 'localhost:8000'),

    'APPLICATION_STATE' => env('APPLICATION_STATE', ''),
    'APPLICATION_CODE' => env('APPLICATION_CODE', 'qazxswedc@12345'),
